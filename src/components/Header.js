        ...
        <div className="ac-ln-wrapper">
            ...
            <div className="ac-ln-content">
                <div className="ac-ln-title">
                    <a className="border-radius-50" href="https://github.com/nambka/Prime"><img src={imgLogo} alt="logo" /></a>
                </div>
                <div className="ac-ln-menu">
                    <a href="https://github.com/nambka/Prime" className="ac-ln-menucta-anchor ac-ln-menucta-anchor-open" id="ac-ln-menustate-open">
                        <span className="ac-ln-menucta-anchor-label">Local Nav Open Menu</span>
                    </a>
                    <a href="https://github.com/nambka/Prime" className="ac-ln-menucta-anchor ac-ln-menucta-anchor-close" id="ac-ln-menustate-close">
                    ...
                    <div className="ac-ln-menu-tray">
                        <ul className="ac-ln-menu-items">
                            ...
                            <li className="ac-ln-menu-item">
                                <a href="https://github.com/nambka/Prime" className="ac-ln-menu-link">Design</a>
                            </li>
                            <li className="ac-ln-menu-item">
                                <a href="https://github.com/nambka/Prime" className="ac-ln-menu-link">Products</a>
                            </li>
                        </ul>
                    </div>
                    <div className="ac-ln-actions">
                        ...
                        <div className="ac-ln-action ac-ln-action-button">
                            <a className="ac-ln-button mr-3" href="https://github.com/nambka/Prime">Login </a>
